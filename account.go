...
var newAccounts map[NumericID]struct{} = make(map[NumericID]struct{})
...
// write it to journal.
func UpdateAccount(acc *Account) { newAccounts[acc.ID] = struct{}{} }

func DeleteAccount(acc *Account) {
	acc.Deleted = true
	newAccounts[acc.ID] = struct{}{}
...
func SaveNewAccounts() int { return Save(newAccounts, Accounts, ACCOUNTS_FILE) }
